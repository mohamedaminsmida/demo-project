...
export default function Welcome() {
    return (
        <Layout
            hero={
                <div className="mx-auto flex w-full max-w-4xl flex-col gap-6 text-center md:text-left">
                    <p className="text-xs font-semibold tracking-[0.4em] text-white/40 uppercase">New chapter</p>
                    <div>
                        <h1 className="text-4xl leading-tight font-semibold text-white md:text-5xl">
                            Building luminous brands with calm confidence.
                        </h1>
                        <p className="mt-4 max-w-2xl text-base text-white/70">
                            We craft product strategy, design systems, and digital experiences for visionary teams. Let’s give your next launch the
        ...
        >
            ...
            <div className="flex flex-col items-center justify-center text-[#1b1b18] dark:text-[#EDEDEC]">
                    ...
                    <main className="flex w-full flex-col-reverse lg:flex-row">
                        ...
                        <div className="relative -mb-px aspect-[335/376] w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-[#1D0002]">
                            ...
                            >
                                ...
                                <g
                                    // mixBlendMode value is valid in modern browsers but missing from current type definitions
