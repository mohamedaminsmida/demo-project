const fr = {
    ...
    booking: {
        ...
        serviceSelection: {
            title: 'Sélectionner des services',
        ...
        appointment: {
            ...
            required: '*',
            loadingHours: 'Chargement des heures disponibles...',
            timezoneNote: 'Les horaires sont affichés dans le fuseau horaire du garage ({timezone}).',
            yourLocalTime: 'Votre heure locale : {time} ({label}).',
        },
        vehicle: {
            title: 'Informations sur le véhicule',
            vehicleType: 'Type de véhicule',
            selectVehicleType: 'Sélectionner le type de véhicule',
            otherVehicleType: 'Autre type de véhicule',
            describeVehicleType: 'Décrivez le type de véhicule',
            vehicleMake: 'Marque du véhicule',
            selectBrand: 'Sélectionner la marque',
            otherNotListed: 'Autre / Non listé',
            enterBrandName: 'Entrez le nom de la marque',
            model: 'Modèle',
            modelPlaceholder: 'ex. Camry',
            year: 'Année',
            selectModelYear: 'Sélectionner l\'année du modèle',
            currentYear: 'Année en cours',
            olderThan1980: '1979 ou plus ancien',
            tireSize: 'Taille des pneus',
            selectTireSize: 'Sélectionner la taille des pneus',
            vin: 'NIV',
            vinPlaceholder: 'NIV à 17 caractères',
            notes: 'Notes',
            notesPlaceholder: 'Notes spécifiques pour notre équipe',
            types: {
                car: 'Voitures',
                lightTruck: 'Camionnettes / VUS',
                truck: 'Camions',
                motorcycle: 'Motos et scooters',
                van: 'Vans et minivans',
                other: 'Autre',
            },
        },
        serviceDetails: {
            title: 'Informations sur le service',
            provideDetails: 'Fournissez les détails pour {count} service sélectionné',
            provideDetailsPlural: 'Fournissez les détails pour {count} services sélectionnés',
            noServicesSelected: 'Aucun service sélectionné',
            goBackAndSelect: 'Veuillez revenir en arrière et sélectionner au moins un service pour continuer.',
            noAdditionalInfo: 'Aucune information supplémentaire requise.',
            readyToBook: 'Ce service est prêt à être réservé sans détails supplémentaires.',
            fieldRequired: 'Ce champ est obligatoire.',
            selectOption: 'Sélectionner une option',
            basePrice: 'Prix de base',
            baseAndOptions: 'Base + options sélectionnées',
            total: 'Total',
            paymentNote: 'Tous les paiements sont effectués sur place, aucun paiement en ligne n\'est requis.',
        },
        customer: {
