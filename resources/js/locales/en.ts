const en = {
    ...
    booking: {
        ...
        appointment: {
            ...
            required: '*',
            loadingHours: 'Loading available hours...',
            timezoneNote: 'Times are shown in the garage timezone ({timezone}).',
            yourLocalTime: 'Your local time: {time} ({label}).',
        },
        vehicle: {
            ...
            describeVehicleType: 'Describe the vehicle type',
            ...
            olderThan1980: '1979 or Older',
            tireSize: 'Tire Size',
            selectTireSize: 'Select tire size',
            vin: 'VIN',
            vinPlaceholder: '17-character VIN',
            notes: 'Notes',
            notesPlaceholder: 'Any specific notes for our team',
            types: {
                car: 'Cars',
                lightTruck: 'Light Trucks / SUVs',
                truck: 'Trucks',
        ...
        serviceDetails: {
            ...
            provideDetails: 'Provide details for {count} selected service',
            provideDetailsPlural: 'Provide details for {count} selected services',
            noServicesSelected: 'No Services Selected',
            goBackAndSelect: 'Please go back and select at least one service to continue.',
            noAdditionalInfo: 'No additional information needed.',
            readyToBook: 'This service is ready to book without extra details.',
            fieldRequired: 'This field is required.',
            selectOption: 'Select an option',
            basePrice: 'Base price',
            baseAndOptions: 'Base + selected options',
            total: 'Total',
            paymentNote: 'All payments are made on site, No online payment is required.',
        },
        customer: {
